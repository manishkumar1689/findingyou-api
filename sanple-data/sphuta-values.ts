...
*/
const sphutaValues = [
	{ name: "lagna__1" }, /* śrī lagna */
	{ name: "lagna__2" }, /* indu lagna */
	{ name: "lagna__3" }, /* varṇada lagna */
	{ name: "lagna__4" }, /* horā lagna */
	{ name: "lagna__5" }, /* ghati lagna */
	{ name: "lagna__6" }, /* vighati lagna */
	{ name: "lagna__7" }, /* vighati lagna */
	{ name: "lagna__8" }, /* bhāva lagna */
	{ name: "sphuta__1" },  /*yogi sphuṭa*/
	{ name: "graha__type_yogi" },    /* yogi */
	{ name: "sphuta__2" },  /* avayogi sphuṭa */
	{ name: "graha__type_avayogi" }, /* avayogi */
	{ name: "sphuta__3" },  /* bīja sphuta */
	{ name: "sphuta__4" },  /* kṣetra sphuṭa */
	{ name: "tithi__type_santana" },   /* santāna tithi */
	{ name: "sphuta__5" },  /* prāṅasphuṭa */
	{ name: "sphuta__6" },  /* dehasphuṭa */
	{ name: "sphuta__7" },  /* mṛtusphuṭa */
	{ name: "sphuta__8" },  /* trisphuṭa */
	{ name: "sphuta__9" },  /* catusphuṭa */
	{ name: "sphuta__10" }, /* pañcasphuṭa */
	{ name: "sphuta__11" }, /* bṛghu bindu */
];
