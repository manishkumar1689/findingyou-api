...
const upagrahaData = {
  ...
  refs: [
    { num: 1, key: 'ka', body: 'su', position: 0.5 },
    { num: 2, key: 'mr', body: 'ma', position: 0.5 },
    { num: 3, key: 'ya', body: 'ju', position: 0.5 },
    { num: 4, key: 'ar', body: 'me', position: 0.5 },
    { num: 5, key: 'gu', body: 'sa', position: 0 },
    { num: 6, key: 'md', body: 'sa', position: 0.5 },
  ],
};
